...
namespace AssemblyChain.Gh.Kernel
{
    public class AcGhDetectContacts : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess dataAccess)
        {
            ...
            if (!assemblyGoo.CastTo(ref assemblyModel) || assemblyModel == null)
            {
                AddRuntimeMessage(GH_RuntimeMessageLevel.Error, "Failed to convert assembly into an assembly model snapshot.");
                return;
            }
